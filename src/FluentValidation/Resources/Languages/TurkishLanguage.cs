...
namespace FluentValidation.Resources {
	...
	internal class TurkishLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"CountValidator" => "'{PropertyName}', {MinCount} ve {MaxCount} arasında eleman sayısına sahip olmalıdır. Toplam {TotalCount} adet eleman girdiniz.",
			"MinimumCountValidator" => "'{PropertyName}', {MinLength} adet elemana veya daha fazlasına sahip olmalıdır. {TotalCount} adet eleman girdiniz.",
			"MaximumCountValidator" => "'{PropertyName}', {MaxLength} adet elemana veya daha azına sahip olmalıdır. {TotalCount} adet eleman girdiniz.",
			"ExactCountValidator" => "'{PropertyName}', {MaxCount} adet elemana sahip olmalıdır. {TotalLength} adet elaman girdiniz.",
