...
namespace FluentValidation.Resources {
	...
	internal class EnglishLanguage {
		...
		public static string GetTranslation(string key) => key switch {
			...
			"CountValidator" => "The count of '{PropertyName}' must be between {MinCount} and {MaxCount}. You entered {TotalCount} items.",
			"MinimumCountValidator" => "The count of '{PropertyName}' must be at least {MinCount}. You entered {TotalCount} items.",
			"MaximumCountValidator" => "The count of '{PropertyName}' must be {MaxCount} or less. You entered {TotalCount} items.",
			"ExactCountValidator" => "The count of '{PropertyName}' must be {MaxCount}. You entered {TotalCount} items.",
